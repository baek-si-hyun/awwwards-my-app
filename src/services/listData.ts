...
export const projectsData = [
  ...
  },
  {
    ...
    fontsFamily: ["Yasashii", "Exo2", "NanumSquareRound"],
  ...
  },
  {
    ...
    fontsFamily: ["GothamMedium", "Helvetica", "ProductSans", "Roboto"],
    colors: ["#ff385c"],
    ko: `국비지원학원에서 팀프로젝트로 만든 최초의 프로젝트 입니다. 팀은 총 5명으로 이루어 졌으며 1명 프론트 1명 백엔드로 짝을 이뤄 프로젝트를 진행했습니다. 나머지 1명은 DB를 관리 및 설계 하였습니다. 해당 프로젝트에는 백엔드는 JAVA, Spring, Spring Boot, Oracle Cloud를 사용 하였으며 프론트엔드는 주로 JQuery를 사용했으며 javascript, Vue는 배운것을 활용해 보기위해 중간중간 사용하였습니다. 총 2달 동안 진행된 이 프로젝트는 1달은 설계 및 사이트분석을 하였고 나머지 1달은 개발을 진행하였습니다. 시간 관계상 html과 css 개발은 기존 에어비앤비의 코드를 가져와 사용하였고 기능, 기술구현만 직접 개발 하였습니다.`,
...
export const rowData: IrowData[] = [
  ...
  {
    id: 7,
    arr: [{ num: 0, text: "awwwards My app" }],
  },
  {
    id: 8,
    arr: [
...
export const date: IAbsoluteBoxData[] = [
  ...
  { id: 4, text: "2022. 12 ~ 2023 .01" },
  { id: 5, text: "2023. 01 ~ 2023 .02" },
  { id: 6, text: "2023. 01 ~ 2023 .02" },
  {
    id: 7,
    text: "2023. 02 ~ 2023 .03",
  },
];
